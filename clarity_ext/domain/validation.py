...
class ValidationResults(object):
    ...
    @property
    def warnings(self):
        return list(filter(lambda result: result.type == ValidationType.WARNING, self.results))

    @property
    def errors(self):
        return list(filter(lambda result: result.type == ValidationType.ERROR, self.results))
