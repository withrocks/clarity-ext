...
class StepRepository(object):
    ...
    def _wrap_artifact(self, artifact, container_repo, gen_type, is_input, process_type):
        ...
        if artifact.type == "Analyte":
            wrapped = self.clarity_mapper.analyte_create_object(artifact, is_input, container_repo, process_type)
        elif artifact.type == "ResultFile" and gen_type == "PerInput":
            wrapped = self.clarity_mapper.result_file_create_object(artifact, is_input, container_repo, process_type)
